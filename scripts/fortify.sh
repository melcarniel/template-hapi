...
/opt/fortify/bin/cloudscan -url https://fortifycontroller.luizalabs.com/cloud-ctrl start -upload -uptoken $FORTIFY_TOKEN -application $APP_NAME 
-version master -b master -scan
